        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <div className="bg-purple-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600">
              Doterra essential oils are known for their unmatched purity, rigorous testing standards, and sustainable sourcing practices. Experience the difference that quality makes in your aromatherapy and wellness routines.
            </p>
          </div>
        </div>
